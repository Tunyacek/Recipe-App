...
async function main() {
  const recipe1 = await prisma.recipe.upsert({
    ...
    create: {
      ...
      instructions: 'Oloupejte a nakrájejte brambory, orestujte cibuli a česnek, přidejte houby a klobásu, vařte do měkka.',
      rating: Rating.FOUR,
  ...
  const recipe2 = await prisma.recipe.upsert({
    ...
    create: {
      ...
      ingredients: '500g hovězího masa, 200ml smetany, mrkev, petržel, celer, cibule, houskový knedlík',
      instructions: 'Uvařte maso se zeleninou, připravte omáčku ze smetany a podávejte s knedlíkem.',
      rating: Rating.FIVE,
      image_url: 'https://unsplash.com/photos/orange-tabby-cat-in-black-and-white-jacket-yJozLVBxNA0',
      prep_time: 30,
      cook_time: 120,
    },
  });
